...
export interface APIInterface {
    ...
    splitPrimary(count: number, satseach: number, WIF: string, satsPerByte: number, address: string): Promise<CommandResultInterface>;
    commit(start: number, end: number, mainUtxoTxid: string, eachUtxoValue: number, fileName: string, mintOwnerFileName: string, WIF: string, satsPerByte: number, address: string): Promise<CommandResultInterface>;
    reveal(start: number, end: number, fileName: string, mintOwnerFileName: string, satsPerByte: number): Promise<CommandResultInterface>;
}
